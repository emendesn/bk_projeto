...
/**************************************************************************
*** Programa: BKCOMC01      | Autor: Marcos B. Abrah�o | Data: 29/09/2009 *
***************************************************************************
*** Descricao: Pesquisa itens de Documentos de entrada                    *
***                                                                       *
***       Obs: Chamada efetuada atraves do ponto de entrada MA103OPC      *
***************************************************************************
*** Parametros:                                                           *
***************************************************************************
*** Retorno: <Nil>                                                        *
...
/*
If Empty(aSd1)
	MsgStop("Nenhum item encontrado", "Aten��o")
	RestArea(aAreaIni)
	Return
EndIf
*/
...
//@ 000, 000 LISTBOX oListID FIELDS HEADER "Filial","Doc","Serie","Item","Produto","Total R$","Hist�rico" SIZE aSize[6],aSize[5] OF oPanelLeft PIXEL 
...
/**************************************************************************
*** Programa: DefAHeader    | Autor:                   | Data: 29/09/2009 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros: <_cAlias> -                                               *
...
/**************************************************************************
*** Programa: ValidPerg     | Autor:                   | Data: 29/09/2009 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros: <cPerg> -                                                 *
...
AADD(aRegistros,{cPerg,"02","Pesquisar hist�rico"      ,"Historico"      ,"Historico"      ,"mv_ch2","C",20,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","","S","",""})
