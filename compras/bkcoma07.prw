...
/**************************************************************************
*** Programa: BKCOMA07      | Autor: Adilson do Prado  | Data: 24/10/2014 *
***************************************************************************
*** Descricao: Copiar Dados de Fornecedor entre empresas tabela SA2       *
***************************************************************************
*** Parametros:                                                           *
***************************************************************************
*** Retorno: <Nil>                                                        *
...
IF !CGC(cCNPJ,,.F.)
	Msgstop("CNPJ Inv�lido. Verifique!!")
	Return Nil
ENDIF
...
IF dbSeek(xFILIAL("SA2")+cCNPJ,.F.)    
	MSGALERT("Fornecedor j� cadastrado c�digo: "+SA2->A2_COD+"  Loja: "+SA2->A2_LOJA+" - "+SA2->A2_NOME)
	Return Nil
ENDIF
...
IF !EMPTY(cA2COD)
	IF cEmpAT==cEmpOR
		MSGALERT("Fornecedor j� cadastrado c�digo: "+cA2COD+"  Loja: "+cA2LOJA+" - "+cA2NOME)
	ELSE
		IF AVISO("Aten��o","Confirma a Inclus�o do Fornecedor?? c�digo: "+cA2COD+"  Loja: "+cA2LOJA+" - "+cA2NOME,{"Sim","N�o"}) == 1
	       CopySA2(cA2ARQ,cA2COD,cA2LOJA)
		Endif
	ENDIF
ELSE
    MSGSTOP("Fornecedor n�o encontrado!!")
ENDIF
...
/**************************************************************************
*** Programa: CopySA2       | Autor:                   | Data: 24/10/2014 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros:  <cA2Arq> -                                               *
...
*** Uso:                                                                  *
**************************************************************************/
STATIC PROCEDURE CopySA2( cA2Arq, cA2Cod, cA2Loja )
...
Begin Transaction 
	...
	IF lMsErroAuto
		...
		MostraErro()
	Else
		MSGINFO("Fornecedor copiado com sucesso!! c�digo: "+SA2->A2_COD+"  Loja: "+SA2->A2_LOJA+" - "+SA2->A2_NOME)
	Endif
End Transaction
...
/**************************************************************************
*** Programa: ValidPerg     | Autor:                   | Data: 24/10/2014 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros: <cPerg> -                                                 *
