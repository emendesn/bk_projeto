...
/**************************************************************************
*** Programa: BKANXA02      | Autor: Marcos B. Abrahao | Data: 02/09/2009 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros:   <cOrigem> -                                             *
...
IF !EMPTY(cDirCtr)
   ...
   Aeval(aArqCtr,{|x| Aadd(aArqList,{x[1],"Integra��o Liq. "+ALLTRIM(SM0->M0_NOME)+" "+SE2->E2_XXCTRID,DTOC(x[3]),ALLTRIM(x[4]),cDirCtr}  )  })
ENDIF
...
If Empty(aArqList)
    ...
    ElseIf cAliasKey == "SE2"
    	IF EMPTY(cDirCtr)
			...
			msUnlock()
		ELSE
			MsgStop("N�o h� anexos integrados (Liq. "+ALLTRIM(SM0->M0_NOME)+")", "Aten��o")
		ENDIF	
    ElseIf cAliasKey == "SE1"
		MsgStop("Problemas entre a base de dados e os anexos", "Aten��o")
		RecLock("SE1",.F.)
...
/**************************************************************************
*** Programa: AbrirAnexo    | Autor:                   | Data: 02/09/2009 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros: <aArqList> -                                              *
...
/**************************************************************************
*** Programa: ExcluirAnexo  | Autor:                   | Data: 02/09/2009 *
***************************************************************************
*** Descricao:                                                            *
***************************************************************************
*** Parametros:  <aArqList> -                                             *
